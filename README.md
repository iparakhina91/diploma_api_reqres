...
Проект состоит из API тестов, в результате которых анализируется интерфейс прикладной программы (API) сайта [reqres.in](https://reqres.in/).\ 
Цель тестирования - убедиться, что интерфейс прикладной программы соответствует ожидаемой функциональности, безопасности, производительности и надежности.\ 
