...
<sub><code>browser</code> – браузер, в котором будут выполняться тесты\
<code>browser_version</code></sub> – версия браузера\
<code>browser_size</code></sub> – размер окна браузера, в котором будут выполняться тесты\
<code>remote_url</code></sub> - адрес удаленного сервера, где будут запускаться тесты</sub>\
