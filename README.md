...
Проект направлен на тестирование интерфейса прикладной программы (API) сайта [reqres.in](https://reqres.in/). 
Тесты выполняются путем отправки запросов к конечным точкам API и сравнения ответа с ожидаемыми результатами.

Разработанная тестовая документация охватывает функциональности <code>Данные о пользователе</code> и <code>Регистрация пользователя</code>. 
...
- тесты напсианы на `REST API` при помощи библиотеки `Rest-assured`
