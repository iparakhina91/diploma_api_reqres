...
- Для генерации тестовых данных использована библиотека `Faker`
- Оформление тестовой документации реализовано посредством аннотаций `Allure`
- Для создания подробных отчетов реализована интеграция с `Allure TestOps`
- Проект интегрирован с `Jira`
